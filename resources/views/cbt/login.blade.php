    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-primary-600 px-8 py-6 text-center">
                ...
                <h2 class="text-2xl font-bold text-white">Login CBT</h2>
                <p class="text-primary-100 mt-2">Computer Based Test</p>
            </div>
            ...
            <div class="px-8 py-8">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">
                                Masukkan nomor pendaftaran Anda untuk memulai ujian CBT. Pastikan pembayaran Anda sudah dikonfirmasi.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Login Form -->
                <form action="{{ route('cbt.authenticate') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                placeholder="Contoh: REG20260001"
                                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors duration-200 @error('registration_number') border-red-500 @enderror"
                                required
                                autofocus
                            >
                        </div>
        ...
        <div class="mt-8 bg-white rounded-lg shadow-md p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Petunjuk Ujian CBT</h3>
            <ul class="space-y-2 text-sm text-gray-600">
                ...
                <li class="flex items-start">
                    ...
                    <span>Waktu ujian adalah 90 menit</span>
                </li>
                <li class="flex items-start">
                    <svg class="h-5 w-5 text-primary-600 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                    </svg>
                    <span>Ujian akan otomatis tersubmit ketika waktu habis</span>
                </li>
                <li class="flex items-start">
                    <svg class="h-5 w-5 text-primary-600 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                    </svg>
                    <span>Anda hanya dapat mengikuti ujian satu kali</span>
                </li>
            </ul>
        </div>
    </div>
