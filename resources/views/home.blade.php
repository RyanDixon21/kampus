...
<section class="relative py-20 bg-gray-50 overflow-hidden">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-t-4 border-blue-600 text-center">
...
<!-- Dosen Section -->
<section id="dosen" class="relative py-24 bg-gray-50 overflow-hidden">
    <!-- Hexagon Pattern -->
    <div class="absolute inset-0 opacity-5">
        <svg class="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-16 animate-on-scroll">
            <h2 class="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
                {{ $settings['dosen_section_title'] ?? 'Dosen' }}
            </h2>
            <p class="text-gray-600 text-lg max-w-2xl mx-auto">{{ $settings['dosen_section_description'] ?? 'Tim pengajar profesional yang siap membimbing dan mendukung kegiatan akademik Anda' }}</p>
        </div>
